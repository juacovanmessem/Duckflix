...
const loadTable = async () => {
  ...
  content.forEach (film =>{
    ...
    <td><button type="button" class="btn btn-light" onclick="deleteContent(this)" id=${film.id}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
    <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
  </svg></button></td>
    <td><button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#editModal">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Seleccione el elemento que desea editar</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="mb-3">
            <label for="select" class="form-label">Elementos:</label>
            <select class="form-select" aria-label="Default select example" id="selectc" required>
              <option value="title">Título</option>
              <option value="category"Comedia">Sinopsis</option>
              <option value="type">Serie/Película</option>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="save" onclick="editContent()">Guardar</button>
        </div>
      </div>
    </div>
  </div></td>
    <td><button type="button" class="btn ${film.spotLight ? 'btn-warning' : 'btn-light'}" id=${film.id} onclick="spotLight(this)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
